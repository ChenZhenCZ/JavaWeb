...
<html>
  ...
  <body>
    ...
    <h1 align="center">&nbsp;提现</h1>
   <hr/>
   <form action="${pageContext.request.contextPath }/uersServlet?action=login2" method="post" name="form1" >
   <input type="hidden" value="${userList.userid }" name="managerId"> 
   <c:if test="${userList.remainMoney }!=null">
   ...
   <input type="hidden" value="0" name="Money">
   	...
   	<tr><td align="right">提现金额:</td><td><input type="text" name="remainMoney"/></td></tr>
