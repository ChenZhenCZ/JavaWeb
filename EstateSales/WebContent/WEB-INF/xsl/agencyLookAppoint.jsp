		...
		<div id="content" class="col-lg-10 col-sm-10">
			<div>
				<ul class="breadcrumb">
					...
					<li><a href="javacsript:void(0);">查看预约</a></li>
				</ul>
			</div>
			<!-- 搜索框 -->
            <div class="col-xs-4 pull-left">
                <div class="input-group">
                    <input type="text" class=" form-control" name="name" placeholder="请员工姓名">
            ...
            <div class="col-xs-12">
                <table id="tb" class="table table-bordered table-hover table-condensed" data-toggle="table"
					data-url="<%=path %>/appointment/AgencyLookAppoint" data-pagination="true" data-striped="true">
					<thead>
						<tr>
							<th data-field="state" data-radio="true"></th>
							<th data-field="emp.name">所属员工</th>
							<th data-field="customer.name">预约客户</th>
							<th data-field="house.name">预约户型</th>
...
<script src="<%=path%>/js/agencyLookAppoint.js"></script>
