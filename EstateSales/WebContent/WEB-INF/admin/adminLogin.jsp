            ...
            <form class="form-horizontal" id="from1" action="<%=path %>/admin/login" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control" name="admin.adminName" placeholder="Username">
                    </div>
                    <div class="clearfix"></div><br>

                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock red"></i></span>
                        <input type="password" class="form-control" name="admin.adminPwd" placeholder="Password">
                    </div>
