		...
		<div id="content" class="col-lg-10 col-sm-10">
			<div>
				<ul class="breadcrumb">
					...
					<li><a href="javacsript:void(0);">销售管理</a></li>
				</ul>
			</div>
            <!-- 表格工具栏开始 -->
            ...
            <div class="col-xs-12">
                <table id="tb" class="table table-bordered table-hover table-condensed" data-toggle="table"
					data-url="<%=path %>/sale/agencyList" data-pagination="true" data-striped="true">
					<thead>
						<tr>
							<th data-field="state" data-radio="true"></th>
							<th data-field="room.hourse.buildings.name">楼盘</th>
							<th data-field="room.hourse.name">户型</th>
							<th data-field="room.name">房号</th>
...
<script src="<%=path %>/js/agencySaleList.js"></script>
