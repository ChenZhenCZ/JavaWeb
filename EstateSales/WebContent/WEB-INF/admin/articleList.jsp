				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li><a href="javacsript:void(0);">文章管理</a></li>
						</ul>
					</div>
					...
					<div class="row">
						...
						<div id="toolbar" class="btn-group">
							<button id="delete" type="button" class="btn btn-danger">
								<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>激活/冻结
							</button>
						</div>
						<div class="col-xs-12">
							<table id="tb" class="table  table-hover" data-toggle="table"
								data-url="<%=path %>/admin/articleList" data-pagination="true"
								data-striped="true">
								<thead>
									<tr>
										...
										<th data-field="created_time" data-formatter="formatDate">创建日期</th>
