				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li><a href="../like/userlist">我的点赞</a></li>
						</ul>
					</div>
			        ...
			        <button  class="del btn btn-info">
			            <span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span> 取消点赞
			        </button>
			    	</div>
			    	<!-- 表格工具栏结束 -->
					<!-- 表格开始 -->
		            <div class="col-xs-12">
		                <table id="tb" class="table table-bordered table-hover table-condensed" data-toggle="table"
							data-url="<%=path %>/like/userListPage" data-pagination="true" data-striped="true">
							<thead>
								<tr>
									<th data-field="state" data-radio="true"></th>
										<th data-field="buildings.name">楼盘名称</th>
									<th data-field="created_time" data-formatter="formatDate">点赞时间</th>
								</tr>
							</thead>
						</table>
		            </div>
...
<script src="<%=path %>/js/table_like.js"></script>
<script>
$('#headicon').fileinput({
    language: 'zh',
