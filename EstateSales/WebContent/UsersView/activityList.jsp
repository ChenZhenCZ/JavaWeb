...
<%@include file="../WEB-INF/views/nav.jsp" %>
    ...
    <div class="container">
		<div class="col-md-12">
			<!-- 用户搜索 -->
			<form action="<%=path%>/admin/allactivityList">
				<div class="col-lg-10" >
				    <div class="input-group">
				      <input type="text" name="activity.title" value="${activity.title}" class="form-control" placeholder="搜索资讯">
            ...
            <div class="col-lg-8 col-md-7">
							  ...
							  <div class="panel-body">
							   	...
							   	<div class="col-lg-9">
									<ul>
										...
										<li style="margin-top:10px;">活动内容:<a>${h.content}</a></li>
										<li style="margin-top:8px;"><span style="color:black;">活动地址:${h.address}&nbsp;&nbsp;&nbsp;&nbsp;<c:if test="${h.buildings.name!=null}">楼盘: ${h.buildings.name}</c:if>
										<c:if test="${h.buildings.name==null}">全网通用</c:if></span><span style="margin-left:40px;"></span></li>
										<li style="margin-top:8px;"><span style="color:black;">活动时间:${h.start_time}——${h.end_time}</span><span style="margin-left:40px;"></span></li>
									</ul>						   	
							   	 </div>
							  </div>
						</div>
						...
						<div style="margin-bottom:50px;">
				    	  <ul id="pagination" class="text-center clearfix">
			                  <li><a href="${pageContext.request.contextPath }/admin/allactivityList?article.title=${article.title}">首页</a></li>
					          <li><a href="${pageContext.request.contextPath }/admin/allactivityList?currentPage=${poj.currentPage}&opr=piror&article.title=${article.title}">上一页</a></li>
					          <li><a href="${pageContext.request.contextPath }/admin/allactivityList?currentPage=${poj.currentPage}&opr=next&article.title=${article.title}">下一页</a></li>
					          <li><a href="${pageContext.request.contextPath }/admin/allactivityList?currentPage=${poj.pageCount}&opr=last&article.title=${article.title}">末页</a></li>
			           	  </ul>
					 </div>					
             </div>
