	      ...
	      <div class="modal-body">
	       	<form  id="activityUpdate">
		        ...
		        <div class="form-group">
		        	...
		        	<input type="text" class="form-control form_datetime" name="activityVO.start_time" required="required" readonly="readonly">
		        </div>
		        <div class="form-group">
		        	<label for="recipient-name" class="control-label">结束时间：</label>
		        	<input type="text" class="form-control form_datetime" name="activityVO.end_time" required="required" readonly="readonly">
		        </div>
		        <div class="form-group">
		        	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		        	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="content" class="col-lg-10 col-sm-10">
			<div>
				<ul class="breadcrumb">
					...
					<li><a href="javacsript:void(0);">楼盘活动管理</a></li>
				</ul>
			</div>
			
            <!-- 表格工具栏开始 -->
	        <div id="toolbar" class="btn-group">
	        <a href="<%=path%>/activity/activityAdd"  class="btn btn-default">
            ...
            <div class="col-xs-12">
                <table id="tb" class="table table-bordered table-hover table-condensed" data-toggle="table"
					data-url="<%=path %>/activity/activityList" data-pagination="true" data-striped="true">
					<thead>
						<tr>
...
<script src="<%=path%>/js/activityList.js"></script>
